import { parseToHtml, toggleTipsDropdown } from '../helpers.js';
    ...
    <div class="forecast-tips-inner flex-col hidden">
      <div class="forecast-tip">
        ...
        <p class="forecast-tip-text">
          On ${forecastWeather.getForecastWeekdayTips()}, the temperature forecast is
          <span class="temp-select">${forecastWeather.getMorningTemp()}</span
          ><span class="deg-style deg-select">&deg;F</span> in the
          morning, <span class="temp-select">${forecastWeather.getDayTemp()}</span
          ><span class="deg-style deg-select">&deg;F</span> mid-day
          and <span class="temp-select">${forecastWeather.getEveningTemp()}</span
          ><span class="deg-style deg-select">&deg;F</span> in the
          evening.
        </p>
      </div>
